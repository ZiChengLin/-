...
@implementation SignTypeThirdCell
...
- (void)initSubViews {
    ...
    _authorNameBtn.frame = CGRectMake(WIDTH-180, 10, 100, 20);
...
- (void)setThird:(SignTypeModel *)third {
    
    _third = third;
    
    [_authorNameBtn setTitle:third.authorName forState:UIControlStateNormal];
    ...
    _cardTitleLabel.text = third.cardTitle;
    
    CGRect cardTitleRect = _cardTitleLabel.frame;
    cardTitleRect.size.height = [[self class] cellContentHeight:third] - 45;
    _cardTitleLabel.frame = cardTitleRect;
    
    CGRect cardTypeTwoImageRect = _cardTypeTwoImage.frame;
    cardTypeTwoImageRect.origin.y = [[self class] cellContentHeight:third] + 20;
    _cardTypeTwoImage.frame = cardTypeTwoImageRect;
    
    CGRect bgCellViewRect = _bgCellView.frame;
    bgCellViewRect.size.height = [[self class] cellContentHeight:third] + _cardTypeTwoImage.frame.size.height + 25;
