...
@implementation CardTypeTwoFourCell
...
- (void)initSubViews {
    ...
    _authorNameBtn.frame = CGRectMake(WIDTH-240, 10, 150, 20);
    ...
    _signBtn.frame = CGRectMake(WIDTH-80, 10, 60, 20);
...
- (void)setTwo:(CardTypeModel *)two {
    
    _two = two;
    [_authorNameBtn setTitle:two.authorName forState:UIControlStateNormal];
    [_signBtn setTitle:two.signName forState:UIControlStateNormal];
    ...
    _cardTitleLabel.text = two.cardTitle;
    
    CGRect cardTitleRect = _cardTitleLabel.frame;
    cardTitleRect.size.height = [[self class] cellContentHeight:two] - 45;
    _cardTitleLabel.frame = cardTitleRect;
    
    CGRect cardTypeTwoImageRect = _cardTypeTwoImage.frame;
    cardTypeTwoImageRect.origin.y = [[self class] cellContentHeight:two] + 20;
    _cardTypeTwoImage.frame = cardTypeTwoImageRect;
    
    CGRect bgCellViewRect = _bgCellView.frame;
    bgCellViewRect.size.height = [[self class] cellContentHeight:two] + _cardTypeTwoImage.frame.size.height + 25;
