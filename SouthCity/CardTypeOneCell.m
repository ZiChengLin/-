...
@implementation CardTypeOneCell
...
- (void)initSubViews {
    ...
    _cardRemarkLabel.textAlignment = NSTextAlignmentLeft;
    [_cardRemarkLabel setVerticalAlignment:VerticalAlignmentTop];    // 自定义的label方法
