...
@implementation SignTypeFourCell
...
- (void)initSubViews {
    ...
    _authorNameBtn.frame = CGRectMake(WIDTH-190, 10, 100, 20);
...
- (void)setFour:(SignTypeModel *)four {
    
    _four = four;
    
    [_authorNameBtn setTitle:four.authorName forState:UIControlStateNormal];
    ...
    _cardTitleLabel.text = four.cardTitle;
    
    CGRect cardTitleRect = _cardTitleLabel.frame;
    cardTitleRect.size.height = [[self class] cellContentHeight:four] - 45;
    _cardTitleLabel.frame = cardTitleRect;
    
    CGRect cardTypeTwoImageRect = _cardTypeTwoImage.frame;
    cardTypeTwoImageRect.origin.y = [[self class] cellContentHeight:four] + 20;
    _cardTypeTwoImage.frame = cardTypeTwoImageRect;
    
    CGRect bgCellViewRect = _bgCellView.frame;
    bgCellViewRect.size.height = [[self class] cellContentHeight:four] + _cardTypeTwoImage.frame.size.height + 25;
